...
このファイルでは、NotebookLM 風プラグインを作るために必要な RAG 関連用語を説明します。

## NotebookLM 風とは何か

ここで言う NotebookLM 風とは、以下のような機能です。
...
NotebookLM 風に近づけるなら、将来 chunk 化が重要になります。
...
将来は、該当箇所の引用やページ番号を出せると NotebookLM に近づきます。
